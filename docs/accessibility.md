...
| Placeholder nav entries | 4.5:1 | 12.0:1 | 13.6:1 |
...
| Current nav entry underline | 3:1 | 8.2:1 | 9.3:1 |
...
| 1.4.1 Use of Color | A | Passes | The current nav entry is bold and underlined as well as colored, and the chosen theme carries a check mark in the Theme menu. Invalid fields carry a text message and `aria-invalid`. Status is shown as text in the grid. |
