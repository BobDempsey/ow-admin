    ...
    @for (field of selectFields; track field.key) {
      <div class="grid gap-1">
        ...
        <select
          [id]="id(field.key)"
          [formField]="fields()[field.key]"
          class="min-h-11 w-full max-w-md select-caret rounded border border-line-input bg-surface pl-3 text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
        >
